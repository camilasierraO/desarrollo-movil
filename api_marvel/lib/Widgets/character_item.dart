...
class CharacterItem extends StatelessWidget {
  ...
  const CharacterItem({Key? key, required this.title, required this.image})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      padding: EdgeInsets.all(35.0), // Relleno para la tarjeta
      child: Card(
        ...
        child: Column(
          children: [
            Container(
              ...
              padding: EdgeInsets.all(0.0), // Relleno para la imagen
              child: Image.network(
                image,
            ...
            Padding(
              padding: EdgeInsets.all(9.0), // Relleno para el título
              child: Text(
                title,
